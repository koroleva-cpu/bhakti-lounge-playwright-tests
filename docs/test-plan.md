...
- Pull requests: smoke suite in Chromium, Firefox and WebKit, plus Ruff.
...
- Recommended branch rule: require `smoke (chromium)`, `smoke (firefox)`, `smoke (webkit)` and `lint` before merge.
